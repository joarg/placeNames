...
import json
import random
from folketelling.spiders.personId import PersonSpider
...
class PersonSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        person_id_spider = PersonSpider()

        # Get person IDs (This will trigger 'personId_spider' to run)
        result = person_id_spider.start_requests() 
        print('result: ', result)
